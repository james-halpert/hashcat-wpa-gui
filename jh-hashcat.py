...
pcapPath = str('~/caps')
hccapPath = str('~/caps/hccap')
dictPath = str('/media/bane/tank/Dictionaries')
homePath = str('$HOME')
def chunk():
	os.system('clear')
pcap = str('x')
...
def option1():
	...
	if choice1 == '1':
		...
		mycommand=str('hcxpcapngtool ' + str(pcap) + ' -o ' + str(hccap))
...
def browse2():
	...
	#This path calls your hccap variable
...
def convert2hccap():
	...
	mycommand='hcxpcapngtool ' + str(pcap) + ' -o ' + str(hccap)
	os.system(str(mycommand))
